...
# Input Lua string
lua_input = """{{['effectFuncs'] = {'castBuff'}, ['triggerPoint'] = 1, ['funcArgs'] = {{{['holder'] = 2, ['lifeRound'] = 2, ['value'] = {16, 1}, ['cfgId'] = 50057043, ['caster'] = 1, __size = 5}}}, ['nodeId'] = 1, __size = 4}}"""
...
print(f"Output has been written to tmp.json")
